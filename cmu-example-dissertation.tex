...
\committeememberone{Dr. Prasad Tetali, Chair}
...
\input{chapter/02-Centralized.tex}
% \input{chapter/02-SchedulingTheory.tex}
\input{chapter/03-POSG.tex}
% \input{chapter/04-POSG.tex}
% \input{chapter/04-CentralizedTaskAllocation}
% \input{chapter/04-DecentralizedTaskAllocation}
% \input{chapter/05-VAMP}
% \input{chapter/07-Equilibria}
\input{chapter/06-MARL}
% \input{chapter/07-Implementation}
\input{chapter/08-Experiments}
\input{chapter/09-Application}
...
% \input{chapter/A-Proofs}
% \input{chapter/B-ImplementationDetails}
% \input{chapter/C-AdditionalExperimentalResults}
% \input{chapter/D-InfrastructureDetails}
