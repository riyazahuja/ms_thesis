...
\label{fig:improver2-dep-isCoatom}
}
% \end{figure}
...
\label{fig:improver2-dep-mem-cross}
% \end{figure}
}
...
\label{fig:improver2-length-super-commute}
}
...
\label{fig:improver2-length-mem-cross}
}
...
\end{paracol}
\captionof{figure}[\ImProver \ optimizes a proof for modularity, increasing modularity score by 2.]{\ImProver \ optimizes a proof for modularity, increasing modularity score (see Definition~\ref{def:modularity_metric}) by 2.}
\label{fig:improver2-modularity-kd-kdb}
}
...
\end{paracol}
\captionof{figure}[\ImProver \ optimizes a proof for modularity, increasing modularity score by 2.]{\ImProver \ optimizes a proof for modularity, increasing modularity score (see Definition~\ref{def:modularity_metric}) by 2.}
\label{fig:improver2-modularity-hilbert-poly}
}
