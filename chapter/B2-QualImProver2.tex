...
\end{paracol}
\captionof{figure}[\ImProver \ optimizes a proof for modularity, increasing modularity score by 2.]{\ImProver \ optimizes a proof for modularity, increasing modularity score (see \ref{app:modularity_metric}) by 2.}
