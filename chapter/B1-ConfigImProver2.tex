...
\begin{subfigure}{0.6\linewidth}
    ...
    \caption{Training accuracy over time on iteration 3 the of dependency metric. }
    \label{fig:IRPO_Dependency_Iter_3_Acc}
\end{subfigure}
\hfill
\begin{subfigure}{0.6\linewidth}
    \includegraphics[width=\textwidth]{figures/Dependency/IRPO Dependency Iter 3 Loss.png}
    \caption{Training loss over time on iteration 3 of the dependency metric. Loss exhibits an overall downward trend. }
    \label{fig:IRPO_Dependency_Iter_3_Loss}
\end{subfigure}
\hfill
\begin{subfigure}{0.6\linewidth}
    \includegraphics[width=\textwidth]{figures/Dependency/IRPO Dependency Iter 3 Margin.png}
    \caption{Average margin over time during training on iteration 3 of the dependency metric. }
    \label{fig:IRPO_Dependency_Iter_3_Margin}
\end{subfigure}
